...
public class AddUnallowedEntityCommand implements CommandExecutor {
		...
		if (src instanceof Player) {
			...
			try {
				...
				if (unallowedEntities.contains(entityId)) {
					player.sendMessage(Text.of("That entity is already added"));
					return CommandResult.empty();
				} else {
					unallowedEntities.add(entityId);
					...
					player.sendMessage(Text.of("You have successfully added ", entityId, " as an unallowed entity in this world"));
