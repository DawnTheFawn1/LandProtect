...
public class LandProtectCommand implements CommandExecutor{
	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		src.sendMessage(Text.of(TextColors.DARK_AQUA, "If you wish to learn how to use ", TextColors.GOLD, LandProtect.PLUGIN_NAME, TextColors.DARK_AQUA, ", enter in /lp help"));
